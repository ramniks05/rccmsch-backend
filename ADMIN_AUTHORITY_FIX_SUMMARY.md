...
- `GET /api/admin/form-schemas/fields/{fieldId}` - Get single field

### ✅ POST Operations
- `POST /api/admin/form-schemas/fields` - Create field
- `POST /api/admin/form-schemas/fields/bulk` - Bulk create fields

### ✅ PUT Operations
- `PUT /api/admin/form-schemas/fields/{fieldId}` - Update field
- `PUT /api/admin/form-schemas/fields/bulk` - Bulk update fields
- `PUT /api/admin/form-schemas/case-types/{caseTypeId}/fields/reorder` - Reorder fields

### ✅ DELETE Operations
- `DELETE /api/admin/form-schemas/fields/{fieldId}` - Delete field
- `DELETE /api/admin/form-schemas/fields/bulk` - Bulk delete fields
